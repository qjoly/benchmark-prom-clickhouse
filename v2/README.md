...
Generated by `v2/plots.py` (matplotlib) from the measured numbers below.

| | |
|---|---|
| ![Write V1 vs V2](docs/charts/write_v1_v2.png) | ![Mimir write scaling](docs/charts/mimir_write_scaling.png) |
| ![Reads on Mimir's axis](docs/charts/reads_mimir_axis.png) | ![Read under concurrency V1 vs V2](docs/charts/read_concurrency_v1_v2.png) |
| ![Storage at scale](docs/charts/storage_scale.png) | ![Resting memory](docs/charts/resting_memory.png) |
| ![High cardinality reads](docs/charts/high_cardinality.png) | |
